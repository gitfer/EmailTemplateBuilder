    ...
    return {
      ...
      link: function postLink(scope, element, attrs) {
      	scope.$on('getHtml', function () {
      		var htmlWrapHead = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">\n<html xmlns="http://www.w3.org/1999/xhtml">\n';
      		...
      		if(attrs.ngPersist !== undefined && attrs.ngPersist === 'true'){
      			$http.post('http://localhost:3000', {data: JSON.stringify(data)});
      		}else{
      			console.log(data);
      		}
      	});
